    ...
    function logincheck(){
		...
		var rememberinput = document.getElementById("rememberinput").value;
        createXMLHttpRequest();   //调用创建XMLHttpRequest对象的方法
        xmlHttp.onreadystatechange=logincheckResult;   //设置回调函数

        var url="LoginAction?action=login&username=" + usernameinput + "&password=" + passwordinput + "&remember=" + rememberinput;
